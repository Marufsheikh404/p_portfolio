        ...
        <section className=" text-white py-10">
            <div className="max-w-7xl mx-auto px-2 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div data-aos="flip-left"
                    ...
                    data-aos-duration="1500" className="bg-[#141414] rounded-2xl p-8 shadow-lg border border-none transition-all duration-500 hover:scale-105 hover:shadow-[0_0_25px_rgba(255,0,76,0.35)]">
